...
The `dataset.csv` file contains the merged data by country from the following 6 sources:
...
- Corruption Perceptions Index (data from 2012 to 2019)
...
## Corruption Perceptions Index (data from 2012 to 2019):
* variables: `cpi_score_2012` to `cpi_score_2019`
